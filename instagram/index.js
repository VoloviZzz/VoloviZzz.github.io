...
var
      ...
      bodyBGpyzo = document.querySelector('.bodyBGpyzo'),
	numLinks, curLink,
...
function onPagLinkClick(e) {
	...
	TL
		.to(indicator, .5, {x: e.target.rect.left - pagContainerRect.left - 15, ease: Quad.easeInOut}, time)
		.to(pagLinks[curLink], .2, {color: '#3a5e77', ease: Linear.easeNone}, time)
		.to(handSVG, .5, {x: e.target.rect.left - pagContainerRect.left - 266, ease: Quad.easeInOut}, time)
    ...
    .to(mouthBG, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(mouth, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(mouthSmallBG, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(mouthLargeBG, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(mouthMaskPath, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(mouthOutline, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(chin, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(earHairL, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(earHairR, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(hair, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(bodyBG, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(bodyBGchanged, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(outerEarR, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(outerEarL, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(earHairL, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(earHairR, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(eyeL, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(eyeR, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(nose, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(face, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(tongue, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(eyebrow, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)
    .to(bodyBGpyzo, .30, {rotation: 0, y: 190, ease: Quad.easeOut}, 0)

    .to(mouthBG, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(mouth, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(mouthSmallBG, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(mouthLargeBG, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(mouthMaskPath, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(mouthOutline, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(chin, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(earHairL, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(earHairR, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(hair, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(bodyBG, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(bodyBGchanged, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(outerEarR, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(outerEarL, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(earHairL, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(earHairR, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(eyeL, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(eyeR, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(nose, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(face, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(tongue, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(eyebrow, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5)
    .to(bodyBGpyzo, .30, {rotation: 0, y: 0, ease: Quad.easeOut}, 1.5);
	TL.play();
	curLink = e.target.num;
  $('#price').text(500 * (curLink + 1));
}
...
function initPagination() {
	...
	TweenMax.set(indicator, {autoAlpha: 1, x: pagLinks[0].rect.left - pagContainerRect.left - 15});
	TweenMax.set(handSVG, {autoAlpha: 1, rotation: 0, x: pagLinks[0].rect.left - pagContainerRect.left - 266, y: yDistance});
